    ...
    <Card className="mb-6">
      <CardContent className="p-4 flex items-center justify-between">
        <div className="flex items-center gap-4">
            <div className="w-16 h-16 bg-white flex items-center justify-center overflow-hidden border p-1 rounded-full">
      ...
      <Sidebar className="hidden sm:block">
        <SidebarHeader>
          <div className="flex items-center gap-2 p-2">
            <div className="w-8 h-8 bg-white flex items-center justify-center overflow-hidden border p-0.5 rounded-full">
