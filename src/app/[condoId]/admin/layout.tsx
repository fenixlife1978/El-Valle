    ...
    const adminNavItems: NavItem[] = [
        ...
        { 
            ...
            items: [
                ...
                { href: `/${condoId}/admin/extraordinary-fund`, label: "Fondo Extraordinario" },
                { href: `/${condoId}/admin/extraordinary-fund/manage`, label: "Gestionar Cuotas" },
                { href: `/${condoId}/admin/expense-support`, label: "Soportes de Gastos" },
