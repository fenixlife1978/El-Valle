...
// REGLA: Email de Super Admin para EFAS CondoSys
                ...
                <form onSubmit={handleLogin}>
                    ...
                    <CardFooter className="flex flex-col gap-4 pb-10 pt-6 px-8">
                        ...
                        <div className="flex justify-between w-full px-1">
                            {loading ? (
                                <span className="text-[11px] font-bold text-muted-foreground uppercase tracking-widest cursor-not-allowed">¿Olvidaste tu clave?</span>
                            ) : (
                                <Link href="/forgot-password" title="Recuperar clave" className="text-[11px] font-bold text-primary hover:underline uppercase tracking-widest">
                                    ¿Olvidaste tu clave?
                                </Link>
                            )}
